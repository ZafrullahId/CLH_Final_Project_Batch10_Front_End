...
<td>{{COUNT}}</td>
<td>{{PRODUCT}}</td>
<td><img src="C:\\Users\\Zafrullah\\Desktop\\Project\\wwwroot\\Images\\{{IMAGE}}" alt="" style="width: 40px; height: 40px;"></td>
<td>{{PRICE}}</td>
<td>{{QUANTITY}}</td>
<td>{{AMOUNT}}</td>
...
<img src="C:\\Users\\Zafrullah\\Desktop\\Project\\wwwroot\\Images\\{{CUSTOMER-IMAGE}}" alt="" style="width: 65px; height: 65px;" class="rounded-circle"></div>
