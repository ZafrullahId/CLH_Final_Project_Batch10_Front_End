...
function myFunction(id) {
    ...
    fetch(`https://localhost:5001/api/Like/GetLikesByReviewId/${id}`)
    .then(res => res.json())
    .then(function(response){
        like.nextElementSibling.innerText = response.data.numberOfLikes;
        like.nextElementSibling.style.color="black"
})
}
