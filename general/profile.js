...
let profile = () => {
    ...
    fetch(`https://localhost:5001/api/Admin/Get/${id}`)
        ...
        .then(function(response){
            ...
            profile_image.innerHTML += `<img class="rounded-circle" src="C:\\Users\\Zafrullah\\Desktop\\Project\\wwwroot\\Images\\${response.data.profileImage}" alt="" style="width: 40px; height: 40px;">`
        })
}

let TEMP = `<img class="rounded-circle me-lg-2" src="C:\\Users\\Zafrullah\\Desktop\\Project\\wwwroot\\Images\\{{IMAGE}}" alt=""
